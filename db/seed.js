...
const seed = async () => {
  try {
    ...
    adminsToSeed.push({ // pushing to admins array as opposed to users array so the hardcoded users show up earlier in the db table
      first_name: 'user1',
      last_name: 'user1',
      email: 'user1@user1',
